...
import eu.sculkpowered.server.attribute.AttributeOperation;
import eu.sculkpowered.server.attribute.AttributeSlot;
import eu.sculkpowered.server.container.item.data.ItemAttributes.Entry;
...
import eu.sculkpowered.server.potion.PotionEffect;
import eu.sculkpowered.server.potion.PotionType;
import eu.sculkpowered.server.protocol.Buffer;
import eu.sculkpowered.server.protocol.Buffer.Reader;
import eu.sculkpowered.server.protocol.Buffer.Writer;
import eu.sculkpowered.server.protocol.ComponentSerializer;
