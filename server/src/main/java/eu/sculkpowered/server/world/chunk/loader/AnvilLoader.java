...
import static eu.sculkpowered.server.util.CoordinateUtil.regionCoordinate;
...
import eu.sculkpowered.server.world.section.Palette;
import eu.sculkpowered.server.world.section.PaletteHolder;
  ...
  public static void loadBlocks(
    ...
    for (var k = 0; k < palette.length; k++) {
      ...
      if (!properties.equals(CompoundBinaryTag.empty())) {
        final var map = new HashMap<String, String>(properties.size());
