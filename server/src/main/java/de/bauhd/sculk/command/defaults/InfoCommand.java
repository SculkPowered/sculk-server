        ...
        return LiteralArgumentBuilder.<CommandSource>literal("info")
                ...
                .executes(context -> {
                    ...
                    context.getSource().sendMessage(text()
                            .append(text("Version: " + MinecraftServer.class.getPackage().getImplementationVersion())).appendNewline()
                            .append(Component.text("CPU: " + SculkMinecraftServer.DECIMAL_FORMAT.format(OPERATING_SYSTEM_MX_BEAN.getCpuLoad() * 100) + "%")).appendNewline()
                            .append(text("RAM (Heap): " +
                                    toMB(heapMemoryUsage.getUsed()) + "/" + toMB(heapMemoryUsage.getMax()))).appendNewline()
