...
import de.bauhd.sculk.enchantment.Enchantment;
import de.bauhd.sculk.entity.player.MinecraftPlayer;
import net.kyori.adventure.text.Component;
import org.jetbrains.annotations.NotNull;

public final class MineEnchantingTableContainer extends MineContainer implements EnchantmentTableContainer {
    ...
    public MineEnchantingTableContainer(final Component title) {
        super(title);
    }
