...
public final class TerminalAppender extends AbstractAppender {
    ...
    public TerminalAppender(final String name, final Filter filter, final Layout<? extends Serializable> layout,
    ...
    public static final class Builder<A extends AbstractAppender.Builder<A>> extends AbstractAppender.Builder<A>
